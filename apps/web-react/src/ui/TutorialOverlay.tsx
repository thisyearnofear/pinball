...
export function TutorialOverlay(props: Props) {
  ...
  const touchscreen = useMemo(() => {
    // Simple heuristic (good enough for Phase B parity)
  ...
  const slides = useMemo(() => {
    const base = touchscreen
      ? [
          ...
          "Swipe up to bump the table.",
        ]
      : [
          "Press ← for left flipper.",
          "Press → for right flipper.",
          "Press spacebar to bump the table.",
        ];
