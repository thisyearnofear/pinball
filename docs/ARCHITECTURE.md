...
- **606 frontend tests** (Vitest + jsdom, 42 files): model/game, story chapter (reducer, run, physics-rig table), coach script, haptics, actors, trigger groups, math utils, HUD layout, audio fetch policy
