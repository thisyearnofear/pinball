 ...
 */
export function getPlayerName(input: string): string {
...
export function validateGameMetadata(metadataStr: string): { valid: boolean; data?: GameMetadata; reason?: string } {
