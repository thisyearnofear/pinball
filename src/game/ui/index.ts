...
export { TableCoach, CoachReplayChip, consumeCoachReplayClick, coachChipTransition, COACH_HOLD_MS } from './TableCoach';
export type { CoachChipState, CoachChipEvent, CoachChipEffect } from './TableCoach';
